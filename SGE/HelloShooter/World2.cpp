...
void World2::Activate()
{
	mActive = true;
}

void World2::Deactivate()
{
	mActive = false;
}

void World2::Initialize()
{
...
void World2::UpdateGameObjects(float deltaTime)
{
	for (int i = 0; i < kMaxEnemies; ++i)
	{
		if (myEnemies[i] != nullptr)
...
void World2::SpawnEnemies(float deltaTime)
{
