...
void IniFile::Load(const char* pFilename)
{
...
int IniFile::GetInt(const char* pTag, int iDefault) const
{
	// Check if we have loaded a file
	if (mLoaded)
	{
...
bool IniFile::GetBool(const char* pTag, bool bDefault) const
{
	// Check if we have loaded a file
	if (mLoaded)
	{
...
float IniFile::GetFloat(const char* pTag, float fDefault) const
{
	// Check if we have loaded a file
	if (mLoaded)
	{
...
const char* IniFile::GetString(const char* pTag, const char* pDefault) const
{
	// Check if we have loaded a file
	if (mLoaded)
	{
