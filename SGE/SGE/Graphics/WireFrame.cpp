...
void WireFrame::Create()
{
	...
	D3DXCreateLine(DXGraphics::Get()->D3DDevice(), &mpLineRenderer);
}
...
void WireFrame::AddLine(float x0, float y0, float x1, float y1)
{
...
void WireFrame::AddRect(float x, float y, float w, float h)
{
...
void WireFrame::AddCircle(float x, float y, float r)
{
...
void WireFrame::SetLineWidth(float fLineWidth)
{
...
void WireFrame::SetColor(DWORD rgb)
{
